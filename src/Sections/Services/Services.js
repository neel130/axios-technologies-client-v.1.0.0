    ...
    <div id='service' className='infoser'  >
      <div className="upper-container">
        ...
        <div className="ai-bi-discription">
          ...
          <h5 style={{ marginBottom: "10px", marginTop: "50px" }} >Nlp Enabled  <svg style={{ height: "20px", width: "50px" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-boxes" viewBox="0 0 16 16">
